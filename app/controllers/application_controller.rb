  ...
  def render_404
    ...
    protected
        ...
        def configure_permitted_parameters
            devise_parameter_sanitizer.for(:sign_up) { |u| u.permit(:name, :email, :password, :password_confirmation, :year_of_joining, :student_type, :roll_no, :phone_number,:tshirt_size) }
